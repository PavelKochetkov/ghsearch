...
export const Card = (props: IDataProps) => {
    const handle = () => {
        fetch(`https://api.github.com/users/${props.items.login}`).then((responce) => {
        ...
        <div className="col-sm-3 mb-3 p-3">
            <div className="card">
                ...
                <div className="card-body">
                    ...
                    <Link to={'/profile/' + props.items.login} onClick={handle} className="btn btn-warning">Подробнее</Link>
                </div>
            </div>
        </div>
    )
